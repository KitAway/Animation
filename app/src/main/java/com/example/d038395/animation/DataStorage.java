...
public class DataStorage implements Serializable{
    static Map<String, DataStorage> voiceDict = new HashMap<>();
    static File app_dir;
    static File data_storage=new File(app_dir+File.separator+ DataStorage.class.toString());
    ...
    public DataStorage(String voiceFileName, String question, String topic) {
    ...
    public DataStorage(File voicePath,String question, String topic) {
            ...
            builder.setTitle("Warning")
                    ...
                    .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            voiceDict.put(DataStorage.this.voiceFileName, DataStorage.this);
                        }
                    })
    ...
    static public void buildFromFile(Context context){
        if(!data_storage.isFile()){
            ...
            try {
                ...
                voiceDict=(HashMap<String , DataStorage>)objIn.readObject();
    ...
    static public void initialize(){
        ...
        data_storage=new File(app_dir+File.separator+"DataStorage");
    }
